...
// Documented, best-practice access policy (minimum-necessary). Server-side
// enforcement is Supabase RLS matching this matrix via role helpers: owner_or_hr
// (payroll), owner_or_admin (user mgmt / settings / audit log), hr_admin_or_owner
// (HR files / performance / disciplinary / exclusion screening),
// clinical_admin_or_owner (controlled substances), and a per-user grant for
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="flex gap-3 py-4">
          ...
          <div className="space-y-1 text-sm">
            <p className="font-medium">This matrix is enforced by row-level security</p>
            <p className="text-muted-foreground">Each sensitive area is gated in the database to the roles shown — Payroll to Owner/HR; controlled substances to Owner/Admin/Clinical Leadership; user management, settings, and the audit log to Owner/Admin; HR files, performance &amp; disciplinary, and exclusion screening to Owner/Admin/HR; and sensitive HR documents to a per-person grant. One item is intentionally stricter than documented: a Manager&rsquo;s view of their own team&rsquo;s performance isn&rsquo;t implemented yet (Managers currently get none).</p>
          </div>
        </CardContent>
      </Card>
