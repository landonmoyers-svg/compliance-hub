...
export function buildSeed(): SeedData {
  return {
    ...
    inventory: [
      { id: "inv-1", createdDate: days(-200), itemName: "Vitals Monitor", itemType: "equipment", status: "active", condition: "good", locationId: "loc-1", removedFromInventory: false },
      { id: "inv-2", createdDate: days(-200), itemName: "Exam Table", itemType: "furniture", status: "active", condition: "fair", locationId: "loc-2", removedFromInventory: false },
      { id: "inv-3", createdDate: days(-150), itemName: "Medication Refrigerator", itemType: "equipment", status: "broken", condition: "poor", locationId: "loc-1", removedFromInventory: false },
