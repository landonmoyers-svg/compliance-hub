...
function regTo(d: Partial<RegulatorySource>) {
  return {
    ...
    ...(d.officialUrl !== undefined && { official_url: d.officialUrl }),
    ...(d.attachmentUrl !== undefined && { attachment_url: d.attachmentUrl }),
...
function inventoryFrom(r: Record<string, unknown>): InventoryItem {
  return {
    ...
    locationId: r.location_id as string | undefined,
    assetTag: (r.asset_tag as string | null) ?? undefined,
...
function inventoryTo(d: Partial<InventoryItem>) {
  return {
    ...
    ...(d.locationId !== undefined && { location_id: d.locationId }),
    ...(d.assetTag !== undefined && { asset_tag: d.assetTag }),
...
function vendorFrom(r: Record<string, unknown>): VendorRecord {
  return {
    ...
    baaDocumentUrl: (r.baa_document_url as string | null) ?? undefined,
...
function vendorTo(d: Partial<VendorRecord>) {
  return {
    ...
    ...(d.baaDocumentUrl !== undefined && { baa_document_url: d.baaDocumentUrl }),
    ...(d.insuranceExpirationDate !== undefined && { insurance_expiration_date: d.insuranceExpirationDate }),
    ...(d.insuranceDocumentUrl !== undefined && { insurance_document_url: d.insuranceDocumentUrl }),
    ...(d.nextReviewDate !== undefined && { next_review_date: d.nextReviewDate }),
    ...(d.status !== undefined && { status: d.status }),
    ...(d.notes !== undefined && { notes: d.notes }),
  };
...
function deaRegistrationFrom(r: Record<string, unknown>): DeaRegistration {
  return {
    ...
    recordsFrom: toISO(r.records_from as string),
    effectiveFrom: toISO(r.effective_from as string),
...
function deaRegistrationTo(d: Partial<DeaRegistration>) {
  return {
    ...
    ...(d.locationId !== undefined && { location_id: d.locationId }),
    ...(d.recordsFrom !== undefined && { records_from: d.recordsFrom }),
...
function deaRecordFrom(r: Record<string, unknown>): DeaRecord {
  return {
    ...
    directedByName: (r.directed_by_name as string | null) ?? undefined,
...
function deaRecordTo(d: Partial<DeaRecord>) {
  return {
    ...
    ...(d.discrepancyNote !== undefined && { discrepancy_note: d.discrepancyNote }),
    ...(d.registrationId !== undefined && { registration_id: d.registrationId }),
    ...(d.directedByName !== undefined && { directed_by_name: d.directedByName }),
...
function orgSettingsFrom(r: Record<string, unknown>): OrganizationSettings {
  return {
    ...
    auditRetentionYears: (r.audit_retention_years as number) ?? 7,
...
function orgSettingsTo(d: Partial<OrganizationSettings>) {
  return {
    ...
    ...(d.auditRetentionYears !== undefined && { audit_retention_years: d.auditRetentionYears }),
